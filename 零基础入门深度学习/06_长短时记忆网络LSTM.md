...
> 📐 本篇用到 [§11 激活函数](../算法原理_数学预备知识.md)、[§7 链式法则](../算法原理_数学预备知识.md)、[§15 特征值与谱半径](../算法原理_数学预备知识.md)（解释"谱半径"时会用到）。
...
- **LSTM** 里旧状态只被**逐元素**乘上 $\mathbf{f}_t$——**每个维度各乘各的，维度之间不混**（$\odot$ 的含义见 [数学预备知识 §3](../算法原理_数学预备知识.md)）。
...
- 本课程 [算法原理_数学预备知识](../算法原理_数学预备知识.md)：[§7 链式法则](../算法原理_数学预备知识.md)、[§11 激活函数](../算法原理_数学预备知识.md)、[§15 谱半径](../算法原理_数学预备知识.md)
