...
| 🧪 **8 个算法案例** | 已交付 4 个，各含**原理 PPT + 可执行 Notebook**（已执行、带输出）；另有 4 个规划中 |
...
| 5 | 分位数 / Conformal 风险区间 | 超越概率 → 风险矩阵 | 规划中.... |
| 6 | PINN | 太沙基固结正问题 → 参数反演 | 规划中.... |
| 7 | 神经算子（FNO / DeepONet） | 替代 FEM 代理模型 | 规划中.... |
| 8 | 时序基础模型（Chronos / TimesFM） | zero-shot 能力边界对比 | 规划中.... |
