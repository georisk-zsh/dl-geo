...
| **1 份数学工具包** | [算法原理_数学预备知识.md](算法原理_数学预备知识.md)：矩阵、偏导、链式法则、softmax、特征值的大白话 + 手算版 |
...
| ② **数学工具** | [算法原理_数学预备知识.md](算法原理_数学预备知识.md)（18 节） | 读文档遇到数学符号卡住时随时查 | 矩阵乘法、逐元素乘与 diag、偏导数梯度、链式法则、softmax、泰勒展开、特征值…… |
...
3. 遇到看不动的数学符号 → 查 [数学预备知识](算法原理_数学预备知识.md) 的对应小节；
...
>
> 📐 **零基础读者先看**：[算法原理_数学预备知识.md](算法原理_数学预备知识.md)——矩阵、偏导数、链式法则、softmax、特征值等工具的「大白话 + 手算例子」版本，四篇原理详解共用。
>
...
**学完如何衔接**：04 卷积神经网络 → [案例3 CNN-Transformer](#案例3-cnn-transformer-混合架构)；05 循环神经网络 / 06 LSTM → [案例1 LSTM](#案例1-lstm-单点位移时序预测)。数学符号看不懂时，随时查阅 [算法原理_数学预备知识.md](算法原理_数学预备知识.md)。
